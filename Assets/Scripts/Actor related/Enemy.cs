...
namespace GOOST
{
    ...
    public class Enemy : Actor, IPoolable<Enemy>, ISegmentable<Actor>
    {
        ...
        [SerializeField]
        private ScreenWrap screenWrap = null;
        ...
        [SerializeField]
        private float aggressionSpeed = 0.5f;

        private float eggTime = 0.0f;
        [SerializeField]
        private float eggCooldown = 2.5f;
        [SerializeField]
        [Range(0.0f, 1.0f)]
        private float eggChance = 0.5f;

        [SerializeField]
        private float platformBounceX = 0.4f;
        [SerializeField]
        private float platformBounceY = 0.75f;

        [SerializeField]
        private float takeOffCooldown = 3.0f;
